...
const CATEGORY_ICONS = {
    ...
    'beach': `${ICON_BASE}/80/beach.png`,
    'hiking': `${ICON_BASE}/80/rucksack.png`,
    'camping': `${ICON_BASE}/80/camping-tent.png`,
    'gym': `${ICON_BASE}/80/dumbbell.png`,
    'sport': `${ICON_BASE}/80/basketball.png`,
    'swimming': `${ICON_BASE}/80/swimming-pool.png`,
    'wintersports': `${ICON_BASE}/80/ski-resort.png`,
    'business': `${ICON_BASE}/80/briefcase.png`,
    'nightout': `${ICON_BASE}/80/skyscrapers.png`,
    'roadtrip': `${ICON_BASE}/80/car.png`,
    'formal': `${ICON_BASE}/80/tie.png`,
};
